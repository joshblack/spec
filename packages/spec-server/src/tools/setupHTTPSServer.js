...
const generateLocalCertificate = (): SelfsignedCertificate => {
  const attrs = [
    {
      name: 'commonName',
      value: 'localhost',
...
const readLocalCertificate = (certPath: string): string =>
  fs.readFileSync(certPath, 'utf8');

const isValidCertificate = (certificatePath: string): boolean => {
...
const setupHTTPSServer = (server: Server) => {

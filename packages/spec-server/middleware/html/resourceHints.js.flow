...
type AssetManifest = { [key: string]: string };
...
const defaultExtract = (chunkNames: Array<string>): Array<string> =>
  chunkNames
 ...
 */
const preloadHints = {
  extract: (manifest: AssetManifest): Array<ResourceHint> =>
...
const print = (resourceHints: Array<ResourceHint>): Array<string> =>
...
const getResourceHints = (manifest: AssetManifest): Array<string> => [
